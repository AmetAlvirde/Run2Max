...
2. **What changed from the sub-issue plan:**
   - No deviations from the interface design. `requireTargetRanges: "comparable"` is the production mode; `NON_COMPARABLE_LABELS = {"E", "LR", "REC"}` is the v1 classification; `MAX_REPEAT_COUNT = 20` is the v1 cap.
